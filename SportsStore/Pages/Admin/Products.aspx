...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <% // ListView CRUD operations 
       // We tell the ListView control which methods to call through a series of attributes in the Web Form 
       // The ListView control takes care of generating the required HTML and JavaScript and ensures that the actions that the user takes lead to our CRUD methods being called.%>
    <asp:ListView ItemType="SportsStore.Models.Product" SelectMethod="GetProducts" DataKeyNames="ProductID" UpdateMethod="UpdateProduct" InsertMethod="InsertProduct" DeleteMethod="DeleteProduct" InsertItemPosition="LastItem" EnableViewState="false" runat="server">
        <LayoutTemplate>
