<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="Checkout.aspx.cs" Inherits="SportsStore.Pages.Checkout" MasterPageFile="~/Pages/Store.Master" %>

<asp:Content ID="Content1" ContentPlaceHolderID="bodyContent" runat="server">
    <% // The "bodyContent" (the whole file) will go into the form in the Store.Master page %>

    <div id="content">
        <% // First content section with runat so we can manipulate the elements in the code-behind class %>
        <div id="checkoutForm" class="checkout" runat="server">
            ...
            <div>
                ...
                <% // client-side validation - data attributes to input elements - is commented out after inserting server control %>
        ...
        <% // The second content section which we will display wehen the checkout process is complete %>
